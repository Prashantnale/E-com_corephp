    ...
    <div class="card-body">
      <form action="" method="post">
        ...
        <div class="row">
          ...
          <!-- /.col -->
          <div class="col-12">
            <button type="submit" name="a_submit" class="btn btn-primary btn-block">Sign In</button>
          </div>
          <!-- /.col -->
        </div>
      </form>
      ...
      if(isset($_POST['a_submit']))
      {
         $uname=$_POST['a_email'];
         $pass=$_POST['a_pass'];
         $query="SELECT * FROM `login` WHERE `username`='$uname' AND `passward`='$pass'";
         ...
         if($uname!="" && $pass!="")
         {
           if($data==1)
           {
            ...
            echo "<script>alert('woring');</script>";
           }
