...
<div class="carousel-item <?=$sk;?>">
    ...
    <div class="container">
    <div class="seller-combo m-4">
        <div class="main-heading d-flex justify-content-between">
          <h2 class="pri-heading">Add prodect</h2>
          
        </div>
        <div class="product-inner">
          <ul>
            <?php
          $queryp="SELECT * FROM `addcard` WHERE 1";
$run=mysqli_query($conn,$queryp);
  ...
  ?>
            ...
            <li class="leaf first">
              <a href="sigle.php?id=<?=$qw;?>">
                ...
                <div class="pro-desc">
                  <div class="pro-name"><?=$row['name'];?></div>
                  <div class="price"> Rs.<?=$row['sale-price'];?></div>
                </div>
