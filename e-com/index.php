              ...
              <div class="header-right">
                <div class="online-cart d-flex align-items-center justify-content-end">
                  ...
                  <a href="addcard.php" type="button" data-bs-toggle="tooltip" data-bs-placement="bottom" title="My Cart"
                    class="righticon me-lg-3 me-md-3 me-sm-2 cart"><span class="count"> 
                 <?php
                  $quer="SELECT * FROM `addcard` WHERE 1";
                  $qw=mysqli_query($conn,$quer);
  ...
  <section class="best-seller-section">
    ...
    <div class="seller-combo mb-4">
        ...
        <div class="product-inner">
          <ul>
            <?php
          $queryp="SELECT * FROM `prodect` WHERE 1 LIMIT 0,4";
$run=mysqli_query($conn,$queryp);
...
<?php
$queryps="SELECT * FROM `p_brand` WHERE 1 LIMIT 0,3";
$runs=mysqli_query($conn,$queryps);
...
?>
          <div class=" col-lg-4 col-md-4 col-sm-12 col-12 text-center">
            <div class="box-cover">
              <a href=""><img
                  src="../Admin/<?=$rows['img'];?>" class="img-fluid"
                  title="Birthday Gifts" alt="Birthday Gifts" width="45%">
                <div class="mft-text-product"><span><?=$rows['Brand'];?></span>
                </div>
              </a>
            </div>
          </div>
      ...
      <div class="seller-combo mb-4">
        ...
        <div class="product-inner">
          <ul>
            <?php
          $queryp="SELECT * FROM `prodect` WHERE 1 LIMIT 8,4";
$run=mysqli_query($conn,$queryp);
...
while($row=mysqli_fetch_assoc($run))
{
  ?>
      ...
      <div class="seller-combo mb-4">
        <div class="main-heading d-flex justify-content-between">
          <h2 class="pri-heading">Men's Footwear</h2>
          <a href=""><span class="view-all">View All</span></a>
        </div>
        <div class="product-inner">
          <ul>
<?php
$oo="SELECT * FROM `prodect` WHERE `p_categary`='5' LIMIT 0,4";
$ssk=mysqli_query($conn,$oo);

while($a=mysqli_fetch_assoc($ssk))
{
...
?>
            ...
            <li class="leaf first">
              <a href="sigle.php?id=<?=$a['p_id'];?>">
                ...
                <div class="pro-desc">
                  <div class="pro-name"><?=$a['p_name'];?></div>
                  <div class="price"> Rs. <s><?php echo$a['p_mrp']." ";?></s><?php echo $a['p_sale_price'];?></div>
                </div>
                <div class="product-list-time">
                  Earliest Delivery:<span class="green-text">Today.</span></div>
              </a>
...
?>
      ...
      <div class="seller-combo mb-4">
        <div class="main-heading d-flex justify-content-between">
          <h2 class="pri-heading">Home Prodect</h2>
          <a href=""><span class="view-all">View All</span></a>
        </div>
        <div class="product-inner">
          <ul>
            <?php
    $queryp="SELECT * FROM `prodect` WHERE `p_categary`='7' LIMIT 0,4 ";
$run=mysqli_query($conn,$queryp);
...
while($row=mysqli_fetch_assoc($run))
{
  ?>
      ...
      <div class="seller-combo mb-4">
        <div class="main-heading d-flex justify-content-between">
          <h2 class="pri-heading">All View</h2>
          <a href=""><span class="view-all">View All</span></a>
        </div>
        <div class="product-inner">
          <ul>
            <?php
          $queryp="SELECT * FROM `prodect` WHERE 1 LIMIT 12,8";
$run=mysqli_query($conn,$queryp);
